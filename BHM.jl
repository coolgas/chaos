...
# ╔═╡ 16e4a38a-d1ae-4bf9-b6bf-eab8c7f0a6a8
using ITensors

# ╔═╡ dc13fc87-ead2-4673-9317-0207823eee7e
let
	ITensors.space(::SiteType"BHM") = 3
...
[[deps.ITensors]]
deps = ["ChainRulesCore", "Compat", "Dictionaries", "HDF5", "IsApprox", "KrylovKit", "LinearAlgebra", "LinearMaps", "NDTensors", "PackageCompiler", "Pkg", "Printf", "Random", "Requires", "SerializedElementArrays", "StaticArrays", "Strided", "TimerOutputs", "TupleTools", "Zeros", "ZygoteRules"]
git-tree-sha1 = "0fca6882fd43d43fdfb4d556718a135bc58dcb97"
